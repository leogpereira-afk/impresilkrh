...
export const STATUS: StatusColaborador[] = [
  ...
  { id: "afastado", nome: "Afastado", cor: "#d97706", contaComoAtivo: true, ordem: 3 },
  { id: "inativo", nome: "Inativo", cor: "#64748b", contaComoAtivo: false, ordem: 4 },
  { id: "direcao", nome: "Direção", cor: "#16334f", contaComoAtivo: false, ordem: 5 },
  { id: "externo", nome: "Externo", cor: "#8b5cf6", contaComoAtivo: false, ordem: 6 },
];
